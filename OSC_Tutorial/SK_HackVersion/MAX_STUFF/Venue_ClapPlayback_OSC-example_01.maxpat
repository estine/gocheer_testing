...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 167.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 207.0, 150.0, 33.0 ],
					"text" : "the value for any clap is arbitrarily set to 74"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 171.0, 50.0, 22.0 ],
					"text" : "74"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 812.0, 166.0, 98.0, 23.0 ],
					"text" : "/socketio 40 44"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 248.0, 118.0, 113.0, 26.0 ],
					"saved_object_attributes" : 					{
						"filename" : "oscroute.js",
						"parameter_enable" : 0
					}
,
					"text" : "js oscroute.js /claps"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 475.75, 171.0, 264.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 812.0, 40.0, 102.0, 24.0 ],
					"text" : "SEND"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 423.75, 29.0, 102.0, 24.0 ],
					"text" : "RECEIVE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 496.75, 118.0, 111.0, 26.0 ],
					"saved_object_attributes" : 					{
						"filename" : "oscroute.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 812.0, 66.0, 149.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 811.0, 249.0, 149.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 812.0, 129.0, 153.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.75, 62.0, 107.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 812.0, 218.0, 148.0, 27.0 ],
...
,
					"patching_rect" : [ 170.0, 418.62994384765625, 75.0, 26.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.0, 458.62994384765625, 150.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 134.054946899414062, 503.0, 21.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 115.554946899414062, 503.0, 14.0, 69.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 73.054946899414062, 387.0, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 100.054946899414062, 503.0, 14.0, 69.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 77.054946899414062, 503.0, 21.0, 74.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 100.054946899414062, 629.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.054946899414062, 418.62994384765625, 82.0, 26.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 73.054946899414062, 458.62994384765625, 196.0, 26.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 821.5, 155.0, 799.0, 155.0, 799.0, 206.0, 821.5, 206.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Google Drive/Audio/GoCheer_SK/gocheer_testing/OSC_Tutorial/SK_HackVersion/MAX_STUFF",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
